...
func (r *ClusterwideNetworkPolicyReconciler) manageDNSProxy(
	...
	if enableDNS && r.DnsProxy == nil {
		...
		if r.DnsProxy, err = dns.NewDNSProxy(r.Ctx, f.Spec.DNSServerAddress, f.Spec.DNSPort, r.DNSCacheUpdateInterval, r.ShootClient, ctrl.Log.WithName("DNS proxy")); err != nil {
