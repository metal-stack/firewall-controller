...
func (in *FirewallStats) DeepCopyInto(out *FirewallStats) {
	*out = *in
	...
	if in.TrafficControlStats != nil {
		in, out := &in.TrafficControlStats, &out.TrafficControlStats
		*out = make(TrafficControlStatsByIface, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
...
func (in *NetworkTrafficSpec) DeepCopyInto(out *NetworkTrafficSpec) {
	*out = *in
	if in.LocalPrefixes != nil {
		in, out := &in.LocalPrefixes, &out.LocalPrefixes
...
func (in *TrafficControl) DeepCopyInto(out *TrafficControl) {
	*out = *in
	if in.Rules != nil {
		...
		*out = make([]TrafficControlRule, len(*in))
		copy(*out, *in)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TrafficControlRule) DeepCopyInto(out *TrafficControlRule) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TrafficControlRule.
func (in *TrafficControlRule) DeepCopy() *TrafficControlRule {
	if in == nil {
		return nil
	}
	out := new(TrafficControlRule)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TrafficControlStats) DeepCopyInto(out *TrafficControlStats) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TrafficControlStats.
func (in *TrafficControlStats) DeepCopy() *TrafficControlStats {
	if in == nil {
		return nil
	}
	out := new(TrafficControlStats)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in TrafficControlStatsByIface) DeepCopyInto(out *TrafficControlStatsByIface) {
	{
		in := &in
		*out = make(TrafficControlStatsByIface, len(*in))
		for key, val := range *in {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TrafficControlStatsByIface.
func (in TrafficControlStatsByIface) DeepCopy() TrafficControlStatsByIface {
	if in == nil {
		return nil
	}
	out := new(TrafficControlStatsByIface)
	in.DeepCopyInto(out)
	return *out
}
