...
type FirewallSpec struct {
	...
	// DEPRECATIONS: CAN BE REMOVED AS SOON AS ALL FIREWALLS WERE UPDATED TO 2.0
	// Data contains the data over which the signature is calculated.
	Data `json:",inline"`
	// Signature of firewall attributes generated by GEPM. DEPRECATED
...
type FirewallDeploymentStatus struct {
	// TODO: Add conditions like AllFirewallsReconciled, Phase "Updating"...
